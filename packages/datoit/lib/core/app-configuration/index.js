...
module.exports = (dir, initialConfig = {}) => {
  ...
  const rootConfig = {
    ...
    installedPlugins: getPrefixedDeps('datoit-plugin', pkgJSON),
    installedMiddlewares: getPrefixedDeps('datoit-middleware', pkgJSON),
    installedHooks: getPrefixedDeps('datoit-hook', pkgJSON),
    installedProviders: getPrefixedDeps('datoit-provider', pkgJSON),
  };
